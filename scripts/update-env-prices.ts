...
const newPrices = {
  ...
  'STRIPE_PRICE_FAMILLE_PLUS_MONTHLY': 'price_1SzRMBHYadstuPY8VTA34Kiw',
...
function main() {
  ...
  const pricesSection = [
    ...
    `STRIPE_PRICE_FAMILLE_PLUS_MONTHLY=${newPrices.STRIPE_PRICE_FAMILLE_PLUS_MONTHLY}`,
    '',
    '# Plans B2C - Annuel',
    ...
    `STRIPE_PRICE_FAMILLE_PLUS_YEARLY=${newPrices.STRIPE_PRICE_FAMILLE_PLUS_YEARLY}`,
    '',
    '# Plans B2B - Mensuel',
    ...
    `STRIPE_PRICE_BUSINESS_MONTHLY=${newPrices.STRIPE_PRICE_BUSINESS_MONTHLY}`,
    '',
    '# Plans B2B - Annuel',
    ...
    `STRIPE_PRICE_BUSINESS_YEARLY=${newPrices.STRIPE_PRICE_BUSINESS_YEARLY}`,
  ]
