// Conditions générales de vente — texte validé (DPO) rendu via composant Markdown léger.
// ============================================================
...
const CGV_MARKDOWN = `<!-- CGV BLOCKTRUST — VERSION 3 (5 juillet 2026), révisée par Laurianne Winter (DPO/juriste), juin 2026.
...
## 1. Objet
Les présentes Conditions Générales de Vente (ci-après « CGV ») ont pour objet de définir les conditions dans lesquelles la société SAS BRNB TECH fournit, à titre onéreux, les services proposés sur la plateforme BLOCKTRUST.
Les services consistent en la réalisation de vérifications techniques (identité, transactions, authenticité de documents) et en la génération de certificats cryptographiques attestant qu’un contrôle a été effectué.

---

## 2. Champ d’application
Les CGV s’appliquent :
- aux clients particuliers (B2C) ;
...
Les services peuvent inclure, selon l’offre souscrite :
- vérification d’identité et de documents (off-chain) ;
...
## 4. Nature de l’obligation
Les services fournis par la plateforme constituent une obligation de moyens renforcée.
La plateforme s’engage à mettre en œuvre des moyens techniques et organisationnels conformes aux standards du marché afin d’assurer la fiabilité des contrôles réalisés, sans garantir un résultat absolu ou permanent, notamment en matière de cybersécurité, de vérification documentaire et de détection de fraude.

---

## 5. Commande et accès aux services
La commande s’effectue en ligne via la plateforme.
L’accès aux services est conditionné à :
- la création d’un compte utilisateur ;
- l’acceptation des CGU et des présentes CGV ;
...
Les services sont proposés sous forme d’abonnements, dont les prix et caractéristiques sont détaillés sur la page “Tarifs” de la plateforme, accessible à l’adresse suivante :
...
Les prix affichés sur la plateforme s’entendent hors taxes, sauf mention contraire.
Le client est seul responsable de la déclaration et du paiement de toutes taxes, droits ou impôts applicables dans son pays de résidence ou d’établissement, le cas échéant.

---

## 7. Modalités de paiement
Le paiement est exigible à la commande.
Les moyens de paiement acceptés sont précisés sur la plateforme.
...
## 8. Abonnement, durée et renouvellement
Les services sont fournis sous la forme d’abonnements conclus pour une durée déterminée, selon la périodicité choisie lors de la souscription (mensuelle ou annuelle).
Sauf résiliation par le client dans les conditions prévues ci-dessous, l’abonnement est reconduit automatiquement à l’issue de chaque période d’engagement, pour une durée identique à celle initialement souscrite.
...
## 9. Durée – Validité des certificats
Les certificats émis sont valables pour la durée indiquée lors de leur émission.
Ils peuvent être :
...
Elle ne saurait être engagée en cas :
- d’informations inexactes ou frauduleuses fournies par le client ;
- d’événements postérieurs à l’émission du certificat ou indicateurs ;
- d’utilisation du certificat en dehors de sa finalité ou de son périmètre.
En tout état de cause, la responsabilité financière de la société est plafonnée au montant effectivement payé par le client au titre du service concerné.
...
## 12. Résiliation
La société se réserve le droit de suspendre ou de résilier l’accès aux services en cas de manquement grave aux présentes CGV ou CGU, notamment en cas de fraude, de non-respect des obligations contractuelles ou d’utilisation abusive du service.
Cette résiliation pourra intervenir de plein droit, sans préavis, sans préjudice des dommages et intérêts auxquels la société pourrait prétendre, et sans préjudice des droits du client en tant que consommateur.

---

## 13. Propriété intellectuelle
La plateforme, les certificats, les marques et les contenus sont protégés par le droit de la propriété intellectuelle.
...
Conformément aux dispositions légales impératives, le consommateur peut saisir, à son choix, l’une des juridictions territorialement compétentes en vertu du Code de procédure civile, ou la juridiction du lieu où il demeurait au moment de la conclusion du contrat ou de la survenance du fait dommageable.
Utilisateurs professionnels (B2B)
Sauf disposition légale impérative contraire, tout litige relatif à l’interprétation, l’exécution ou la cessation des présentes est soumis à la compétence exclusive du Tribunal de commerce de Créteil, y compris en cas de pluralité de défendeurs ou d’appel en garantie.

---

## 16. Médiation de la consommation
Conformément aux dispositions des articles L.612-1 et suivants du Code de la consommation, le client agissant en qualité de consommateur a le droit de recourir gratuitement à un médiateur de la consommation en vue de la résolution amiable d’un litige avec la société.
...
## 17. Force majeure
La responsabilité de la société ne pourra être engagée en cas d’inexécution ou de retard dans l’exécution de ses obligations résultant d’un cas de force majeure au sens de l’article 1218 du Code civil.
Sont notamment considérés comme cas de force majeure, sans que cette liste soit limitative : catastrophes naturelles, incendies, pannes de réseau, défaillance des fournisseurs ou prestataires, cyberattaques, interruptions des services de télécommunications, décisions des autorités publiques ou tout événement échappant au contrôle raisonnable de la société.
En cas de survenance d’un tel événement, l’exécution des obligations est suspendue pendant toute la durée de la force majeure.
...
- Date de souscription : __________________________
- Nom du client : __________________________
- Adresse du client : __________________________
