  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="font-syne mt-6 text-2xl font-extrabold leading-tight text-white sm:text-4xl">
          Prêt à sécuriser votre <span className="text-bt-cyan">identité digitale</span> ?
        </h2>
