  ...
  return (
    ...
    >
      ...
      <Reveal delay={80} className="mx-auto mt-10 max-w-3xl text-center">
        ...
        <p className="font-syne mx-auto max-w-3xl text-balance text-lg font-semibold leading-snug text-white sm:text-xl">
          Avant de répondre, signer ou payer — sachez à qui vous avez vraiment affaire.
        </p>
        <p className="mx-auto mt-4 max-w-2xl text-balance text-sm leading-relaxed text-white/65 sm:text-base">
          Identité, contexte et réputation de chaque contact — vérifiés avant toute interaction.
        </p>
      </Reveal>
        ...
        {layers.map((layer, i) => {
          ...
          return (
            ...
            >
              ...
              <h3 className="font-syne text-balance text-lg font-semibold text-white">{layer.title}</h3>
              <p className="mt-1.5 text-balance text-sm font-medium text-white/80">{layer.question}</p>
      ...
      <Reveal delay={200} className="mx-auto mt-10 max-w-3xl text-center">
        <p className="mx-auto text-balance text-sm leading-relaxed text-white/55 sm:text-base">
      ...
      <Reveal delay={300} className="mx-auto mt-8 max-w-2xl rounded-xl border border-white/10 bg-white/[0.02] p-5 text-center">
        <p className="text-balance text-sm leading-relaxed text-white/75 sm:text-base">
