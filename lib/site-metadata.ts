...
export const SITE_DESCRIPTION =
  "Solution française de certification d'identité numérique. Protégez vos échanges contre l'usurpation d'identité, les faux RIB et le phishing. Ancrage blockchain Polygon. Sans engagement.";
